    ...
    return (
        <Col span={24}>
            <Row justify="space-between">
                ...
                <Col className='col-price' pull={1}>
                    <h1 className='h1-price'>
                        ${product.precio.toFixed(2)}
                    </h1>
                    <Space size="large">
                        {[...Array(4)].map((_, index) => (
                            <CreditCardOutlined className='icon-card' key={index} />
                        ))}
                    </Space>
                </Col>
            </Row>
            ...
            <Row className='row-security' justify="end" align="middle">
            ...
            <Row className='row-text' justify={'end'} align={'middle'}>
                <p>
